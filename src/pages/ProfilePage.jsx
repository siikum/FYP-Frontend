              ...
              {savedItineraries.length > 0 ? (
                savedItineraries.map((item) => (
                  <div
                    ...
                    className="cursor-pointer mb-6 bg-white p-5 rounded-lg shadow hover:shadow-md transition flex flex-col"
                  >
                    <h4 className="text-xl font-semibold text-[#0B3D20] mb-2">
                      {item.destination}
                    </h4>
                    <p className="text-gray-700 text-sm mb-2">
                      {item.start_date} ➔ {item.end_date}
                    </p>
                    <div className="text-gray-600 text-sm max-h-20 overflow-hidden line-clamp-3 mb-4">
                      {item.plan_details?.slice(0, 250)}...
                    </div>
                    <span className="text-sm font-semibold text-[#0B3D20] hover:underline">
                      View full itinerary ➔
                    </span>
                  </div>
                ))
