  ...
  return (
    <div className="w-full flex h-screen relative">
      <motion.img
        ...
        whileInView={{ opacity: [0.25, 0.35, 0.75, 1] }}
        transition={{ duration: 2, ease: "easeInOut", type: "spring" }}
        src={currentImg}
        className="h-full w-full object-cover"
      />
      <div className="w-[700px] h-full flex flex-col justify-center absolute z-10 gap-y-7 text-white m-[4%]">
        <motion.div
          initial={{
            visibility: "hidden",
            y: 400,
        ...
        <motion.div
          ...
          className="text-lg"
        >
          Embark on a journey to discover Nepal’s hidden treasures <br />{" "}
          unexplored, overlooked, and truly unforgettable!
        </motion.div>
        <motion.button
          initial={{
            visibility: "hidden",
          ...
          transition={{ duration: 1, ease: "easeInOut" }}
          onClick={() => {
            navigate("/destination/lomanthang");
          }}
          className="px-6 py-2 bg-white rounded-sm w-fit text-lg font-medium text-black"
        >
          Explore Now
        </motion.button>
      </div>
      <motion.svg
        width="800.36517"
        height="454.28867"
        className="absolute bottom-40 right-10 z-[20] scale-[60%]"
        initial="hidden"
        animate="visible"
        variants={{ visible: { transition: { staggerChildren: 0.15 } } }} // Stagger animation
      >
        <motion.path
          ...
          onClick={() => setCurrentIMG(firstIMG)}
          stroke={currentImg === firstIMG ? "blue" : "black"}
          fill={currentImg === firstIMG ? "red" : "white"}
        ...
        <motion.path
          ...
          id="NP-BH"
          className="opacity-60"
          onClick={() => setCurrentIMG(secondIMG)}
          stroke={currentImg === secondIMG ? "blue" : "black"}
          fill={currentImg === secondIMG ? "red" : "white"}
        />
        <motion.path
          variants={pathVariants}
          ...
          id="NP-DH"
          className="opacity-60"
          onClick={() => setCurrentIMG(thirdIMG)}
          stroke={currentImg === thirdIMG ? "blue" : "black"}
          fill={currentImg === thirdIMG ? "red" : "white"}
        />
        <motion.path
          variants={pathVariants}
          ...
          id="NP-GA"
          className="opacity-60"
          onClick={() => setCurrentIMG(fourthIMG)}
          stroke={currentImg === fourthIMG ? "blue" : "black"}
          fill={currentImg === fourthIMG ? "red" : "white"}
        />
        <motion.path
          variants={pathVariants}
